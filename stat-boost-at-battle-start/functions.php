...
Examples:
    {"stat":"attack","amount":1}
        would boost attack by one stage at start of battle
    {"stat":"defense","amount":1,"condition":"attack < 0"}
        would boost defense by one stage at start of battle when the user's attack is lower than zero (neutral)
    {"stat":"speed","amount":5,"condition":"energy <= 50%","repeat":false}
        would boost speed by five stages at the start of battle when the user's life energy is below 50% but only once
