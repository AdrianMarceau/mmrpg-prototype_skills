...
$functions = array(
    ...
    'rpg-ability_stat-boost_before' => function($objects){
        ...
        if ($this_robot->has_item('reverse-module')){
            ...
            $options->extra_text .= '<br /> '.$this_robot->print_name().'\'s '.$options->stat_type.' was not lowered by '.rpg_type::print_span('time', 'Reverse Module').' shenanigans!';
